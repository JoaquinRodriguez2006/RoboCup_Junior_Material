...
def lineas():
    ...
    if r == 233 and g == 233 and b == 233:
        avanzar(2)
        print("Estamos en el blanco")
    # Red
    elif r == 252 and g == 64 and b == 64:
       print("EStamos en el rojo")
    # Blue
    elif r == 64 and g == 64 and b == 252:
        print("Estamos en el azul")
    # Purple
    elif r == 148 and g == 65 and b == 228:
        print("Estamos en el violeta")
    #Checkpoint
    elif r == 241 and g == 242 and b == 241:
        print("Estamos en el checkpoint")
    # Swamp
    elif r == 212 and g == 179 and b == 104:
        print("Estamos en el swamp")
    # Black Hole
    elif r == 43 and g == 43 and b == 43:
        print("Estamos en el pozo")
        rotar_enclavado(180)
        avanzar(2)
        if r == 233 and g == 233 and b == 233:
            avanzar(0)
